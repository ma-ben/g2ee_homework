...
<br><br>
    ...
    <input type="submit" value="选择课程">
</div>
</form>
<div style="text-align:center;">
  <button onclick="location.href='addCourse.jsp'" style="margin-right: 80px;">新增</button>
  <button onclick="location.href='delCourse.jsp'">删除</button>
  <button onclick="location.href='hitCourse.jsp'">返回我的课程</button>
